...
var path        = require('path')
  , parse       = require(path.join(__dirname, '..', '..', '..', 'narcissus', 'lib', 'parser')).parse
  , _           = require(path.join(__dirname, '..', 'underscore'))._
  , Trait       = require(path.join(__dirname, '..', 'traits')).Trait
  , Interpreter = require(path.join(__dirname, 'interp')).Interpreter
  , TagReader   = require(path.join(__dirname, 'reader')).TagReader
  , TagWriter   = require(path.join(__dirname, 'writer')).TagWriter
  ;
